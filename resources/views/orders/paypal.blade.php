...
<section id="do_action">
  <div class="container">
    <div class="heading" align="center">
      ...
      <P><img style="width:50px;height:50px" src="{{url('images/frontend_img/banners/bca.png')}}" alt="" /> <b>BANK BCA : 0123456</b></P>
      <P><img style="width:50px;height:50px" src="{{url('images/frontend_img/banners/bni.png')}}" alt="" /> <b>BANK BNI : 012345678</b></P>
