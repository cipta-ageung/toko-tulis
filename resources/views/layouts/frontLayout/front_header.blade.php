                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +62 822 9921 7725</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> SMFotokopi@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{url('')}}">
                            <img  src="{{url('/images/frontend_img/home/smlogo.png')}}" alt="" /></a>
                    </div>
